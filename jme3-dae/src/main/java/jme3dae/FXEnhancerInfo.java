...
public class FXEnhancerInfo
{
   ...
   public static enum IgnoreLights {ON, OFF}

   public static enum NormalMapGenerator {ON, OFF}

   public static enum TwoSidedMaterial {ON, OFF}

   public static enum IgnoreMeasuringUnit {ON, OFF}

   public static enum UseJME3Materials {ON, OFF}
   ...
   public static FXEnhancerInfo create(NormalMapGenerator ngen, TwoSidedMaterial tsmat, IgnoreMeasuringUnit igm, IgnoreLights il)
   {
      return new FXEnhancerInfo(ngen == NormalMapGenerator.ON, tsmat == TwoSidedMaterial.ON, igm == IgnoreMeasuringUnit.ON, il == IgnoreLights.ON, true);
   }

   public static FXEnhancerInfo create(NormalMapGenerator ngen, TwoSidedMaterial tsmat, IgnoreMeasuringUnit igm)
   {
      return new FXEnhancerInfo(ngen == NormalMapGenerator.ON, tsmat == TwoSidedMaterial.ON, igm == IgnoreMeasuringUnit.ON, false, true);
   }
   ...
   {
      return new FXEnhancerInfo(ngen == NormalMapGenerator.ON, tsmat == TwoSidedMaterial.ON, igm == IgnoreMeasuringUnit.ON, il == IgnoreLights.ON,
                                ujm == UseJME3Materials.ON);
   }

   public static FXEnhancerInfo create(NormalMapGenerator ngen, TwoSidedMaterial tsmat)
   {
      return new FXEnhancerInfo(ngen == NormalMapGenerator.ON, tsmat == TwoSidedMaterial.ON, false, false, true);
   }
