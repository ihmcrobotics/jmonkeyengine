...
public class Main extends SimpleApplication
{
   ...
   public static void main(String[] args) throws MalformedURLException, URISyntaxException
   {
      ...
      // {
      // model = new File(new URL(fileName).toURI()).toString();
      // }
      // else
      // {
      // model = new File(fileName).toURI().toURL().toString();
      // }
      // modelParent = new File(fileName).getParentFile().toURI().toURL().toString();
   ...
   public void simpleInitApp()
   {
      ...
      ColladaDocumentFactory.setFXEnhance(FXEnhancerInfo.create(FXEnhancerInfo.NormalMapGenerator.ON, FXEnhancerInfo.TwoSidedMaterial.ON,
