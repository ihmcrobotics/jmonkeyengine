...
public interface ColladaSpec141
{
   ...
   enum FXSurfaceType
   {
      TYPE_UNTYPED, TYPE_1D, TYPE_2D, TYPE_3D, TYPE_CUBE, TYPE_DEPTH, TYPE_RECT,
   }

   /**
    * Node type enumeration
    */
   enum NodeType {JOINT, NODE}
   ...
   enum Semantic
   {
      BINORMAL, COLOR, CONTINUITY, IMAGE, INPUT, IN_TANGENT, INTERPOLATION, INV_BIND_MATRIX, JOINT, LINEAR_STEPS, MORPH_TARGET, MORPH_WEIGHT, NORMAL, OUTPUT,
      OUT_TANGENT, POSITION, TANGENT, TEXBINORMAL, TEXCOORD, TEXTANGENT, UV, VERTEX, WEIGHT
   }
