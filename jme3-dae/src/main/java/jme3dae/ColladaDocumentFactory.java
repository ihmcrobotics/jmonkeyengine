...
public class ColladaDocumentFactory
{
   public static class FXSettingsGenerator
   {
      ...
      {
         fx = new FXEnhancerInfo(fx.getAutoBump(), fx.getTwoSided(), v == IgnoreMeasuringUnit.ON, fx.getIgnoreLights(), fx.getUseJME3Materials());
      ...
      {
         fx = new FXEnhancerInfo(v == NormalMapGenerator.ON, fx.getTwoSided(), fx.getIgnoreMeasuringUnit(), fx.getIgnoreLights(), fx.getUseJME3Materials());
      ...
      {
         fx = new FXEnhancerInfo(fx.getAutoBump(), fx.getTwoSided(), fx.getIgnoreMeasuringUnit(), v == IgnoreLights.ON, fx.getUseJME3Materials());
      ...
      {
         fx = new FXEnhancerInfo(fx.getAutoBump(), m == TwoSidedMaterial.ON, fx.getIgnoreMeasuringUnit(), fx.getIgnoreLights(), fx.getUseJME3Materials());
      ...
      {
         fx = new FXEnhancerInfo(fx.getAutoBump(), fx.getTwoSided(), fx.getIgnoreMeasuringUnit(), fx.getIgnoreLights(), m == UseJME3Materials.ON);
